...
from src.async_assistant import ChatCompletionAssistant
import re

TWILIO_SAMPLE_RATE = 8000
ENCODING = "mulaw"
#BUFFER_SIZE = 20 * 160  #20 chunks of 160 bytes each


class DeepgramTranscriber:
    def __init__(self, assistant: ChatCompletionAssistant, ws: WebSocket, stream_sid):
